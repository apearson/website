...
var App = /** @class */ (function () {
    ...
    App.prototype.grabMonthlyData = function () {
    ...
    App.prototype.initChart = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, chartData, chartCanvas, context, chart;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.grabMonthlyData()];
                    case 1:
                        data = _a.sent();
                        chartData = data.map(function (month) { return ({ x: new Date(month.date), y: month.kWh }); });
                        chartCanvas = document.getElementsByTagName('canvas')[0];
                        context = chartCanvas.getContext('2d');
                        chart = new __WEBPACK_IMPORTED_MODULE_0_chart_js__["Chart"](context, {
                            type: 'line',
                            data: {
                                datasets: [
                                    {
